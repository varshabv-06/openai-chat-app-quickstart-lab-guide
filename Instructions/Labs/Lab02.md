...
1. Configure Environment Variables
    ...
    ```
    ![](../media/L2-T2-S3.png)
    to list all files, including hidden ones, in the directory. Look for the file named **.env.sample** in the project folder.
    
     Navigate to the **Microsoft Entra ID** in the Azure portal and copy the Tenant ID from there.


     Once located, open the file using the command 
    ```powershell
    code .env.sample
    ```
